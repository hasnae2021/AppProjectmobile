...
public class DisplayData extends AppCompatActivity {
    ...
    private class Custom extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textView1 = (TextView) convertView.findViewById(R.id.sushiName);
            textView2 = (TextView) convertView.findViewById(R.id.txtChoice);
            textView3 = (TextView) convertView.findViewById(R.id.txtNature);
            textView4 = (TextView) convertView.findViewById(R.id.addSauce);
            textView5 = (TextView) convertView.findViewById(R.id.addToppings);
